<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TransferOrderMgr.aspx.cs" Inherits="Gold.Order.TransferOrderMgr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="boxContent">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtSupplier" runat="server" MaxLength="50" Width="187px" />
                        <ajaxToolkit:AutoCompleteExtender  runat="server" ID="aceSupplier" Enabled="true"
                            TargetControlID="txtSupplier" ServiceMethod="GetSupplier"  CompletionInterval="300"
    ...
    <div class="box">
        ...
        <div style="width: 99%; height: 500px;" class="divScroll" id="gridviewContainer"
            ...
            <asp:GridView ID="grdTransferOrderInfo" runat="server" AutoGenerateColumns="False" Width="2450px"
               ...
               sortExpression="OrderCode" sortDirection="ASC" 
                OnSorting="grdTransferOrderInfo_Sorting" AllowSorting="True"
                OnPageIndexChanging="grdTransferOrderInfo_PageIndexChanging" 
                OnDataBound="grdTransferOrderInfo_DataBound">                
                ...
                <Columns> 
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="OrderCode" SortExpression="OrderCode" 
                        DataNavigateUrlFormatString="TransferOrderView.aspx?orderCode={0}" 
                    ...
                    <asp:BoundField DataField="OrderDate" HeaderText="订单日期" DataFormatString="{0:yyyy-MM-dd}"
                        SortExpression="OrderDate" ItemStyle-Width="120px" />
                    ...
                    <asp:BoundField DataField="Supplier" HeaderText="供货单位"  ItemStyle-Width="140px"
                        SortExpression="Supplier" />
                    <asp:BoundField DataField="BusinessDepartmentName"  ItemStyle-Width="100px"
                        HeaderText="业务部门" 
                        SortExpression="BusinessDepartmentName" />
                    <asp:BoundField DataField="Operator" HeaderText="业务员"  ItemStyle-Width="80px"
                        SortExpression="Operator" />
                    <asp:BoundField DataField="InWHName" HeaderText="调入仓库"  ItemStyle-Width="100px"
                        SortExpression="InWHName" />
                    <asp:BoundField DataField="InOrganization" HeaderText="调入组织"  ItemStyle-Width="120px"
                        SortExpression="InOrganization" />
                    <asp:BoundField DataField="InCompany" HeaderText="调入公司"  ItemStyle-Width="160px"
                        SortExpression="InCompany" />
                    <asp:BoundField DataField="OutWHName" HeaderText="调出仓库"  ItemStyle-Width="100px"
                        SortExpression="InWHName" />
                    <asp:BoundField DataField="OutOrganization" HeaderText="调出组织"  ItemStyle-Width="120px"
                        SortExpression="OutOrganization" />
                    <asp:BoundField DataField="OutCompany" HeaderText="调出公司"  ItemStyle-Width="160px"
                        SortExpression="OutCompany" />
                    <asp:BoundField DataField="StoreKeeper" HeaderText="库管员"  ItemStyle-Width="80px"
                        SortExpression="StoreKeeper" />
                    <asp:BoundField DataField="Checker" HeaderText="验收员"  ItemStyle-Width="80px"
                    ...
                    <asp:BoundField DataField="RFIDActorName" HeaderText="RFID处理人姓名"  ItemStyle-Width="100px"
                        SortExpression="RFIDActorName" />
                    <asp:BoundField DataField="RFIDActorTime" HeaderText="RFID处理人时间"  ItemStyle-Width="140px"
            ...
            <div class="modalBody">
                <div id="silverlightControlHost" class="uploadControl">
                    <object data="data:application/x-silverlight-2," type="application/x-silverlight-2"
                        ...
                        <param name="initParams" value="UploadPage=../Upload/FileUpload.ashx,FileType=调拨订单" />
