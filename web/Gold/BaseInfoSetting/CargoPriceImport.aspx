<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CargoPriceImport.aspx.cs" Inherits="Gold.BaseInfoSetting.CargoPriceImport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="commonPage">
        <div class="commonTitle">
            <asp:Label ID="lblTitle" runat="server" Text="商品价格导入"></asp:Label>
        </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <div id="MyFile" style="width: 800px;">
                            <input id="File1" type="file" runat="server" size="50" name="File" /></div>
