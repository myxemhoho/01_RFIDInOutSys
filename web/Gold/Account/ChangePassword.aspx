<%@ Page Title="更改密码" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.cs" Inherits="Gold.Account.ChangePassword" %>
        ...
        <ChangePasswordTemplate>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="CancelPushButton" runat="server" CausesValidation="False" PostBackUrl="~/Default.aspx" Text="取消"/><!--CommandName="Cancel"-->
