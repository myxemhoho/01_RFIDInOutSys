<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StockOutFromNC.aspx.cs" Inherits="Gold.StockMove.StockOutFromNC" %>
        ...
        <div class="orderFooter"> 
            ...
            <asp:Button ID="btnSubmit" runat="server" CausesValidation="false" 
             ...
             <asp:Button ID="btnReturn" runat="server" CausesValidation="false" Visible="true"
                   Text="返回出库单列表" CssClass="ButtonMidWidthImageStyle" onclick="btnReturn_Click" /> 
        </div>
